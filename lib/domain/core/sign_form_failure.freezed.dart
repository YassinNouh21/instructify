...
part of 'sign_form_failure.dart';
...
mixin _$SignFormFailure<T> {
  ...
  @JsonKey(ignore: true)
  $SignFormFailureCopyWith<T, SignFormFailure<T>> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $SignFormFailureCopyWith<T, $Res> {
  factory $SignFormFailureCopyWith(
          SignFormFailure<T> value, $Res Function(SignFormFailure<T>) then) =
      _$SignFormFailureCopyWithImpl<T, $Res>;
  $Res call({T failedValue});
}

/// @nodoc
class _$SignFormFailureCopyWithImpl<T, $Res>
    implements $SignFormFailureCopyWith<T, $Res> {
  _$SignFormFailureCopyWithImpl(this._value, this._then);

  final SignFormFailure<T> _value;
  // ignore: unused_field
  final $Res Function(SignFormFailure<T>) _then;
...
class _$ExceedingLength<T> implements ExceedingLength<T> {
  ...
  @override
  String toString() {
    return 'SignFormFailure<$T>.exceedingLength(failedValue: $failedValue, max: $max)';
  }
...
abstract class ExceedingLength<T> implements SignFormFailure<T> {
...
class _$Empty<T> implements Empty<T> {
  ...
  @override
  String toString() {
    return 'SignFormFailure<$T>.empty(failedValue: $failedValue)';
  }
...
abstract class Empty<T> implements SignFormFailure<T> {
...
class _$Multiline<T> implements Multiline<T> {
  ...
  @override
  String toString() {
    return 'SignFormFailure<$T>.multiline(failedValue: $failedValue)';
  }
...
abstract class Multiline<T> implements SignFormFailure<T> {
...
class _$ListTooLong<T> implements ListTooLong<T> {
  ...
  @override
  String toString() {
    return 'SignFormFailure<$T>.listTooLong(failedValue: $failedValue, max: $max)';
  }
...
abstract class ListTooLong<T> implements SignFormFailure<T> {
...
class _$InvalidEmail<T> implements InvalidEmail<T> {
  ...
  @override
  String toString() {
    return 'SignFormFailure<$T>.invalidEmail(failedValue: $failedValue)';
  }
...
abstract class InvalidEmail<T> implements SignFormFailure<T> {
...
class _$ShortPassword<T> implements ShortPassword<T> {
  ...
  @override
  String toString() {
    return 'SignFormFailure<$T>.shortPassword(failedValue: $failedValue)';
  }
...
abstract class ShortPassword<T> implements SignFormFailure<T> {
